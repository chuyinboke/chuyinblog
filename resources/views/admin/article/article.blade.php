...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
            	<form class="mws-form" action="/admin/article" method="post" enctype="multipart/form-data" class="banner-upload">
            		{{ csrf_field() }}
            		<div class="mws-form-inline">
            			...
            			<div class="mws-form-row">
            				...
            				<div class="mws-form-item">
            					<select class="small" name='fenlei'>
            		...
            		<div class="mws-form-row">
            			...
            			<div class="mws-form-item">
                			 <!-- 加载编辑器的容器 -->
						    <script id="container" name="content" type="text/plain" class="small" name="content">
